...
class AVEDatasetV2(Dataset):
    def __init__(self, data_root, split='train', ratio=0.751):
        ...
        self.meta_csv = os.path.join(data_root, f'OVAVE/ovave_trainratio{ratio}_meta.csv')
    ...
    def _get_label(self, video_name):
        ...
        # 你的 train.py 截取前67类，如果全0则被视为无事件。
        # 为了保证有数据训练，如果 JSON 为空，则认为该视频属于 CSV 里的类别 (Weak Label)
