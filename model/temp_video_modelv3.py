...
class Temp_Model(nn.Module):
    def __init__(self, in_channels, feature_dim):
        ...
        # Encoder / Decoder
        self.video_encoder = InternalTemporalRelationModule(input_dim=768, d_model=256, feedforward_dim=1024)
        self.video_decoder = CrossModalRelationAttModule(input_dim=768, d_model=256, feedforward_dim=1024)
        self.audio_encoder = InternalTemporalRelationModule(input_dim=768, d_model=256, feedforward_dim=1024)
        self.audio_decoder = CrossModalRelationAttModule(input_dim=768, d_model=256, feedforward_dim=1024)
        ...
        # ★★★ 可视化相关配置 ★★★
        self.vis_base_path = r"E:\map\qianhou"  # 基础保存路径
